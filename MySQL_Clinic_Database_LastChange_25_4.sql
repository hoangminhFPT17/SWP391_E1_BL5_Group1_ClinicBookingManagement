...
CHANGE COLUMN `status` `status` ENUM('Pending', 'Approved', 'Waiting', 'In progress', 'Cancelled', 'On-hand-off','Back-from-hand-off', 'Completed', 'Waiting-Payment', 'Payment-Complete') NULL DEFAULT 'Pending' ;