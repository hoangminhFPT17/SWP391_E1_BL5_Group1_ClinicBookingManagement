                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="password" name="currentPassword" placeholder="Old password" required="">
                                            </div>
                                        </div><!--end col-->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="password" name="confirmPassword" placeholder="Re-type New password" required="">
                                            </div>
                                        </div><!--end col-->
