...
<head>
    ...
    <style>
        .detail-table th { width: 200px; position: relative; }
        .filter-input { width: 100%; box-sizing: border-box; margin-top: 4px; }
        .sort-btn { border: none; background: transparent; padding: 0 4px; cursor: pointer; font-size: 0.9em; }
        .pagination li { display: inline-block; margin: 0 2px; }
        .pagination li.active a { font-weight: bold; }
        .filter-buttons { margin-bottom: 1rem; }
        .filter-buttons button { margin-right: 0.5rem; }
    </style>
</head>
<body>
<div class="page-wrapper doctris-theme toggled">
    ...
    <main class="page-content bg-light">
        ...
        <div class="container-fluid" style="margin-top:80px;">
            ...
            <form id="searchForm" method="get" action="${pageContext.request.contextPath}/doctor/AppointmentManager" class="mb-3">
                ...
                <tbody>
                    <c:forEach var="appt" items="${appointments}" varStatus="status">
                        <tr>
                            ...
                            <td>${appt.status}</td>
                            <td>
                                <a href="${pageContext.request.contextPath}/doctor/QueueManager?appointmentId=${appt.appointmentId}" class="btn btn-sm btn-primary">View</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderPagination() {
        ...
        const createLi = (text, fn, active) => {
            ...
            a.className='px-3 py-2 border'; a.innerText = text;
            a.addEventListener('click', e => { e.preventDefault(); fn(); });
            li.appendChild(a);
            return li;
        };
        pagination.appendChild(createLi('Prev', () => { if(currentPage>1) currentPage--, render(); }, false));
        for(let i=1;i<=totalPages;i++) {
            pagination.appendChild(createLi(i, () => { currentPage=i; render(); }, i===currentPage));
        }
        pagination.appendChild(createLi('Next', () => { if(currentPage<totalPages) currentPage++, render(); }, false));
    }
