                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form class="inline-form" method="post"
                                              action="${pageContext.request.contextPath}/TransferPatient">

                                            <input type="hidden" name="handoffId" value="${h.handoffId}"/>

                                            <!-- Start: only when Pending -->
                                            <button type="submit" name="action" value="start"
                                                    class="btn btn-sm btn-primary"
                                                    <c:if test="${h.status ne 'Pending'}">disabled</c:if>>
                                                        Start
                                                    </button>

                                                    <!-- Finish: only when In Progress -->
                                                    <button type="submit" name="action" value="finish"
                                                            class="btn btn-sm btn-success"
                                                    <c:if test="${h.status ne 'In Progress'}">disabled</c:if>>
                                                        Finish
                                                    </button>
                                            </form>
                                        </td>
