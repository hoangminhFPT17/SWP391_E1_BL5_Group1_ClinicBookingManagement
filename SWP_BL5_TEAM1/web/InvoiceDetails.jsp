<%-- 
    ...
    Created on : Apr 27, 2025, 11:40:15 PM
    Author     : JackGarland
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <!-- Navbar End -->
        <%
            InvoiceDetailed invoice = (InvoiceDetailed) request.getAttribute("invoice");
            if (invoice == null) { %>
                    ...
                    <div class="col-lg-10">
                        <div class="card bg-white border-0 rounded shadow px-4 py-5">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-8 col-md-6">
                                    ...
                                    <small id="invoiceAddress" class="text-muted mb-0">${invoice.address}</small>
                                </div>
                                <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    <ul class="list-unstyled">
                                        <li class="d-flex">
                                            <small class="mb-0 text-muted">Invoice no. : </small>
                                            <small id="invoiceNumber" class="mb-0 text-dark">&nbsp;&nbsp;${invoice.invoiceId}</small>
                                        </li>
                                        ...
                                        <li class="d-flex mt-2">
                                            ...
                                            <small id="invoicePatient" class="mb-0">&nbsp;&nbsp;${invoice.patientName}</small>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="pt-4 border-top">
                                <div class="row">
                                    <div class="col-lg-8 col-md-6">
                                        ...
                                        <h6 id="invoicePackage">${invoice.packageName}</h6>
                                    </div>
                                    <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                        <ul class="list-unstyled">
                                            <li class="d-flex mt-2">
                                                <small class="mb-0 text-muted">Issue Dt. : </small>
                                                <small id="invoiceIssue" class="mb-0 text-dark">&nbsp;&nbsp;${invoice.issueDate}</small>
                                            </li>
                                            <li class="d-flex mt-2">
                                                <small class="mb-0 text-muted">Due Dt. : </small>
                                                <small id="invoiceDue" class="mb-0 text-dark">&nbsp;&nbsp;${invoice.dueDate}</small>
                                            </li>
                                            <li class="d-flex mt-2">
                                                <small class="mb-0 text-muted">Dr. Name : </small>
                                                <small id="invoiceDoctor" class="mb-0 text-dark">&nbsp;&nbsp;${invoice.doctorName}</small>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-5 ms-auto">
                                            <ul class="list-unstyled h6 fw-normal mt-4 mb-0 ms-md-5 ms-lg-4">
                                                <li class="text-muted d-flex justify-content-between pe-3">Subtotal :<span id="invoiceSubtotal">${invoice.getSubtotal()}</span></li>
                                                <li class="text-muted d-flex justify-content-between pe-3">Taxes :<span id="invoiceTaxes">0</span></li>
                                                <li class="d-flex justify-content-between pe-3">Total :<span id="invoiceTotal">${invoice.getTotal()}</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="text-end mt-4 pt-2">
                            ...
                            <form action="payment" method="post">
                                ...
                                %>
                                <button type="submit" class="btn btn-soft-primary">Pay</button>
                            </form>
                        </div>
