...
<html>
    ...
    <body>
        ...
        <!-- Start Hero -->
        <section class="bg-half-170 d-table w-100" style="background: url('${pageContext.request.contextPath}/assets/images/bg/department.jpg') center center;">
                        ...
                        <div class="section-title text-center">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-3">
                                <ul class="breadcrumb bg-light rounded mb-0 py-1 px-2">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Examination Package</li>
                                </ul>
                            </nav>
                        </div>
                    </div><!--end col-->
